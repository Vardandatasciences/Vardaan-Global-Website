    ...
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="nav-container">
        ...
        <ul className="nav-links">
          ...
          <li className={`dropdown-li ${activeItem === 'services' ? 'active' : ''} ${servicesDropdownOpen ? 'dropdown-open' : ''}`}>
            ...
            <div className="dropdown-menu">
              <a href="/services/cloud-services" onClick={() => setActiveItem('services')}>
              ...
              <a href="/services/cyber-security" onClick={() => setActiveItem('services')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18" className="dropdown-icon">
                  <path d="M0 0h24v24H0z" fill="none"/>
              ...
              <a href="/services/data-sciences" onClick={() => setActiveItem('services')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18" className="dropdown-icon">
                  <path d="M0 0h24v24H0z" fill="none"/>
              ...
              <a href="/services/resources" onClick={() => setActiveItem('services')}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="18" height="18" className="dropdown-icon">
                  <path d="M0 0h24v24H0z" fill="none"/>
